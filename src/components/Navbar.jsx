...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar ${isVisible ? 'navbar--visible' : 'navbar--hidden'}`}>
      {/* Left side */}
      <a href="/portfolio#about" className="navbar__brand" onClick={handleBrandClick}>Kiki</a>

      {/* Right side */}
      <ul className="navbar__links">
        <li><a href="/portfolio#projects" onClick={(e) => handleSectionClick(e, 'projects')}>Projects</a></li>
